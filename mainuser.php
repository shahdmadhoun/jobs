        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    ...
                    <a class='nav-link' href='mainuser.php'>Home <span class='sr-only'>(current)</span></a>

                </li>
                <li class="nav-item active">

<a class='nav-link' href='jobtype.php?job_type=?$jobtype'>JOB Preference <span class='sr-only'>(current)</span></a>
        ...
        <div style="text-align: right;">
            <form action="logout.php" style="display: inline;">
                <button type="submit" class="btn btn-secondary" style="background-color:#3a1618;">Logout</button>
            </form>
    ...
    <div class="container-fluid">
      ...
      require 'connect.php';
        ...
        $query = "SELECT * FROM Jobsoffering order by respons desc  LIMIT 6";
