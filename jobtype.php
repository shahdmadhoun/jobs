...
$sql="SELECT * FROM jobsoffering WHERE job_type LIKE '$type'";

$result = mysqli_query($conn,$sql);
 

echo "<h3 style='background-color: rgba(255, 255, 255, 0.8) ; text-align:center;' class='display-2'>The List Of Your Preference JOB </h3>";
